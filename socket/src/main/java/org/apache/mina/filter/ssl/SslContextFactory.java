...
public class SslContextFactory {
     ...
     * using {@link KeyManagerFactory#getInstance(String)} or
     ...
     * {@link KeyManagerFactory#getInstance(String)} will be used
     ...
     * {@link KeyManagerFactory#init(KeyStore, char[])} when
     ...
     * using {@link TrustManagerFactory#getInstance(String)} or
    ...
    /**
     * Sets the {@link KeyStore} which will be used in the call to
     * {@link TrustManagerFactory#init(KeyStore)} when
     * the {@link SSLContext} is created.
     * <p>
     ...
     * {@link TrustManagerFactory#init(ManagerFactoryParameters)} when
     * the {@link SSLContext} is created.
     *
     ...
     * {@link TrustManagerFactory#getInstance(String)} will be used
