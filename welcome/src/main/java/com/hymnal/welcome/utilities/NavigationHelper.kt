...
import com.hymnal.welcome.BuildConfig
...
fun Activity.navActivity(path: String) {
    ARouter.getInstance().build(path)
//                .withTransition(R.anim.slide_in_right, R.anim.slide_out_right)
        .navigation()
}

fun Activity.navActivity(path: String, p0: String) {
    ARouter.getInstance().build(path)
//                .withTransition(R.anim.slide_in_right, R.anim.slide_out_right)
        .withString("url", p0)
        .navigation()
...
fun Activity.navActivity(path: String, code: Int) {
    ARouter.getInstance().build(path)
